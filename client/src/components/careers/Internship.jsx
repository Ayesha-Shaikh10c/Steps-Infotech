...
| SECOND PROJECT URL
|--------------------------------------------------------------------------
| Yahan apne second project ka actual URL add kar dena.
|
| Example:
| const SECOND_PROJECT_URL = "https://your-second-project.com";
|
*/
const SECOND_PROJECT_URL = "YOUR_SECOND_PROJECT_URL";
...
function Internship() {
  const handleInternshipApply = () => {
    if (!SECOND_PROJECT_URL || SECOND_PROJECT_URL === "YOUR_SECOND_PROJECT_URL") {
      console.warn("Please add the second project URL in Internship.jsx");
      return;
    }

    window.location.href = SECOND_PROJECT_URL;
  };
    ...
    <section className="w-full bg-white py-9">
      ...
      >
        ...
        >
          ...
          <img
            src={Second}
            alt="Steps Infotech Internship Program"
            className="
              absolute
              inset-0
              h-full
